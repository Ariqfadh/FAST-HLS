...
HLS_SOURCES = ../../../../fast_keypoint_detection_tb.cpp ../../../../fast_keypoint_detection.cpp
...
$(ObjDir)/fast_keypoint_detection_tb.o: ../../../../fast_keypoint_detection_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../fast_keypoint_detection_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fast_keypoint_detection_tb.d

$(ObjDir)/fast_keypoint_detection.o: ../../../../fast_keypoint_detection.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../fast_keypoint_detection.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/fast_keypoint_detection.d
