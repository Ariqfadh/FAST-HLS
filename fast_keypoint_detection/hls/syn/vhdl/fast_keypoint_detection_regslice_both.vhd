...
entity fast_keypoint_detection_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity fast_keypoint_detection_regslice_both;

architecture behave of fast_keypoint_detection_regslice_both is
